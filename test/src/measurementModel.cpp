...
SCENARIO("Calling analytical and autodiff measurment model with 0 measurements"){
    Eigen::VectorXd y;
    srand (time(NULL));
...
SCENARIO("Calling analytical and autodiff measurment model with 2 measurements and fixed state"){
...
SCENARIO("Calling analytical and autodiff measurment model with 2 measurements"){
    Eigen::VectorXd y(16,1);
    srand (time(NULL));
    int num_iterations = 100;
...
SCENARIO("Calling analytical and autodiff measurment model with 2 measurements and states all zero"){
    // 1 tag measurement
    Eigen::VectorXd y(16,1);
    srand (time(NULL));
...
SCENARIO("Calling analytical and autodiff measurment model with random states and random pixel measurements"){
